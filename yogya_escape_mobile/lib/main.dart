        ...
        child: Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: NetworkImage(
                        "https://i.pinimg.com/736x/47/db/3c/47db3c5d52fb2085a2c6d16be5a9c91a.jpg"),
                    fit: BoxFit.cover)),
            child: Stack(
              children: <Widget>[
                Container(
                ...
                Center(
                  ...
                  children: [
                    Image.asset(
                      'img/Escape white.png',
                      width: 257,
                    ),
                    const Text("Yogya Escape",
                        style: TextStyle(
                            fontSize: 24,
                            color: Colors.white,
                            fontFamily: 'italiana')),
                    const Text("Let’s begin your adventure in Yogyakarta",
                        style: TextStyle(
                            fontSize: 15,
                            color: Colors.white,
                            fontFamily: 'italiana')),
